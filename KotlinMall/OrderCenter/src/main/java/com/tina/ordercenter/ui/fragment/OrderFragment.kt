package com.tina.ordercenter.ui.fragment
...
import com.tina.ordercenter.presenter.OrderListPresenter
...
class OrderFragment: BaseMvpFragment<OrderListPresenter>(), OrderListView {
    ...
    private fun initView() {
        mOrderRv.layoutManager = LinearLayoutManager(act)
        mAdapter = OrderAdapter(act)
